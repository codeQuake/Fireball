...
<div class="contentNavigation">
	<nav>
		<ul>		
			...
			{/if}
			<li><a href="{link application='cms' controller='PageList'}{/link}" title="{lang}fireball.acp.menu.link.fireball.page.list{/lang}" class="button"><span class="icon icon16 icon-list"></span> <span>{lang}fireball.acp.menu.link.fireball.page.list{/lang}</span></a></li>
