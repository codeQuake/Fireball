...
<div class="contentNavigation">
    <nav>
        <ul>
			...
			{if $contentID != 0}<li><a href="{link application='cms' controller='ContentSectionList' id=$contentID}{/link}" title="{lang}cms.acp.content.content.section.list{/lang}" class="button"><span class="icon icon24 icon-list-alt"></span> <span>{lang}cms.acp.content.content.section.list{/lang}</span></a></li>{/if}
