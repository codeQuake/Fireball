<dl class="wide">
	<dt><label for="contentData[text]">{lang}cms.acp.content.type.de.codequake.cms.content.type.template.text{/lang}</label></dt>
	<dd>
    	...
    	{include file='codemirror' codemirrorMode='smarty' codemirrorSelector='#contentData[text]'}
	</dd>
</dl>
