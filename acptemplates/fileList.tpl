...
<script data-relocate="true">
	require(['Language', 'Fireball/codeQuake/Acp/FileInlineEditor'], function(Language, FileInlineEditor) {
		Language.addObject({
...
<div class="contentNavigation">
	...
	<nav>
		<ul>
			...
			{/if}
			<li><a href="{link application='cms' controller='FileCategoryAdd'}{/link}" class="button"><span class="icon icon16 fa-plus"></span> <span>{lang}wcf.category.add{/lang}</span></a></li>
			{if $categoryList|iterator_count}
