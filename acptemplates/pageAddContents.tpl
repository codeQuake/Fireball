						...
						<li class="sortableNode sortableNoNesting jsContentRow" data-object-id="{$content->contentID}">
							<span class="sortableNodeLabel"><span class="icon icon16 icon-file-alt"></span>
								...
								<span class="statusDisplay sortableButtonContainer">
									...
									<a href="{link controller='ContentSectionList' id=$content->contentID application='cms'}{/link}" title="{lang}cms.acp.content.content.section.list{/lang}" class="jsTooltip"><span class="icon icon16 icon-list-alt"></span><span class="badge ">{#$content->getSections()|count}</span></a>
								</span>
							</span>
						</li>
					{/foreach}
