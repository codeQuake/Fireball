...
<div class="contentNavigation">
	<nav>
		<ul>
			...
			{/if}
			<li><a href="{link application='cms' controller='StylesheetList'}{/link}" title="{lang}fireball.acp.menu.link.fireball.stylesheet.list{/lang}" class="button"><span class="icon icon16 fa-list"></span> <span>{lang}fireball.acp.menu.link.fireball.stylesheet.list{/lang}</span></a></li>
