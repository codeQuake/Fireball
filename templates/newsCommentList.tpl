...
{if $commentCanAdd}"<ul id="newsCommentList" class="commentList containerList" data-can-add="true" data-object-id="{@$news->newsID}" data-object-type-id="{@$commentObjectTypeID}" data-comments="{@$commentList->countObjects()}" data-last-comment-time="{@$lastCommentTime}">
