<figure>
	...
	<img src="{$image->getURL()}" alt="{$image->title}" title="{if $data['text']|isset}{$data['text']|language}{/if}" class="jsTooltip" {if $data['width']|isset && $data['height']|isset}style="width: {$data['width']}px;"{/if}/>
