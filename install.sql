...
--section_type
DROP TABLE IF EXISTS cms1_content_section_type;
CREATE TABLE cms1_content_section_type(
sectionTypeID INT (10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
title VARCHAR(255),
...
ALTER TABLE cms1_content_section ADD FOREIGN KEY (sectionTypeID) REFERENCES cms1_content_section_type (sectionTypeID) ON DELETE SET NULL;