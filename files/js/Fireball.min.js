...
Fireball.Content.Dragging=Class.extend({_pageID:0,init:function(a){this._pageID=a;a=$('<div class="sortableListContainer sortableContentList" id="sortableContentListBody" />').insertAfter($(".userNotice"));var b='<ol class="sortableList" data-object-id="0">',c=0;$("div[id^='cmsContent']").each(function(){var a=$(this).parents("div[id^='cmsContent']").length,b=$(this).children("div[id^='cmsContent']").length;$(this).addClass("ui-droppable").attr({"data-depth":a,"data-children":b}).prepend('<span class="sortableNodeLabel">'+
